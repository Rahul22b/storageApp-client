            ...
            <div className="absolute right-0 top-4 mt-2 w-48 bg-white rounded-md shadow-md z-10 border border-gray-300 overflow-hidden">
              {loggedIn ? (
                <>
                  ...
                  <Link to="/subscription" className="flex items-center gap-2 text-gray-700 cursor-pointer hover:bg-gray-200 px-4 py-2">
                    <FaShoppingCart className="text-blue-600" /> Buy Subscription
                  </Link>
